...
l_1 = pygame.image.load('Resources/Textures/1_lives.png')
...
class Character(pygame.sprite.Sprite):
    ...
    def move(self, move_left, move_right):
        ...
        if self.rect.left + x_change < 440 or self.rect.right + x_change > SCREEN_WIDTH - 640:
...
def endless_mode():
    ...
    while playing:
        ...
        if GLOBAL_X % 3600 in range(1500, 1600) and GLOBAL_X - map_last_update not in range(0, 100) and GLOBAL_X > map_last_update:
